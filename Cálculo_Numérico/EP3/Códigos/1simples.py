...
p_values_simple = [p for p, N, I_num, erro in erros if erro > 0]
erro_values_simple = [np.log2(erro) for p, N, I_num, erro in erros if erro > 0]

# Divisão em duas regiões para análise visual
p_values_region1 = p_values_simple[:5]
erro_values_region1 = erro_values_simple[:5]
p_values_region2 = p_values_simple[5:11]
erro_values_region2 = erro_values_simple[5:11]
...
plt.scatter(p_values_simple, erro_values_simple, label='erro (simples)', marker='o', color='blue')
